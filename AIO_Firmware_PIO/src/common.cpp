...
IMU mpu;               // IMU object
SdCard tf;             // SD card object
Pixel rgb;             // Pixel object
// Config g_cfg;       // Global configuration file
Network g_network;     // Network connection object
FlashFS g_flashCfg;    // File system in flash (replaces Preferences)
Display screen;        // Screen object
Ambient ambLight;      // Light sensor object

// lvgl handle lock
SemaphoreHandle_t lvgl_mutex = xSemaphoreCreateMutex();

// Function to delay for a specified interval
